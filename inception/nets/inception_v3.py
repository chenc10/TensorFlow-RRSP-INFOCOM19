...
#                padding='SAME', scope='Conv2d_2a_{}x{}'.format(*kernel_size))
            aux_logits = slim.conv2d(
...
#          net = slim.avg_pool2d(net, kernel_size, padding='SAME',
