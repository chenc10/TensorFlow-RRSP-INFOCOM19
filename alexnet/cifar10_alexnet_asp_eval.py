...
#            loss = cifar10.loss(logits, labels, batch_size)
	    ...
	    #----------------------eval
#	    eval_images, eval_labels = cifar10.distorted_inputs(128)
#	    eval_images = tf.reshape(eval_images, [-1, _HEIGHT, _WIDTH, _DEPTH])
#	    eval_labels = tf.one_hot(eval_labels, 10, 1, 0)
#	    (eval_logits,_) = network_fn(eval_images)
