...
#nohup /home/ubuntu/chen-models/inception/bazel-bin/inception/imagenet_distributed_train --batch_size=32 --data_dir=/home/ubuntu/imagenet_data --job_name=ps --task_id=0 --ps_hosts=$ps_hosts --worker_hosts=$worker_hosts  >/home/ubuntu/master1.log 2>&1 &
	nohup ssh $i "python /home/ubuntu/chen-models/inception/imagenet_inception_rrsp.py --batch_size=32 --data_dir=/home/ubuntu/imagenet_data --job_name=ps --task_id=$num --ps_hosts=$ps_hosts --worker_hosts=$worker_hosts"  >/home/ubuntu/master$num.log 2>&1 &
	num=$((num+1))
done
...
#	nohup ssh $i "python om.py 0.8" &
	nohup ssh $i "python /home/ubuntu/chen-models/inception/imagenet_inception_rrsp.py --batch_size=32 --data_dir=/home/ubuntu/imagenet_data --job_name=worker --task_id=$num --ps_hosts=$ps_hosts --worker_hosts=$worker_hosts" > /home/ubuntu/slave$num.log 2>&1 &
