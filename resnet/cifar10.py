...
def train(total_loss, global_step, batch_size=FLAGS.batch_size):
  ...
  with tf.control_dependencies([loss_averages_op]):
    ...
    grads = [(tf.scalar_mul(tf.cast(batch_size/FLAGS.batch_size, tf.float32), grad), var) for grad, var in grads]
